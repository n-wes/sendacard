<template>
  <div>
    ...
    <q-drawer show-if-above v-model="leftDrawerOpen" side="left" bordered>
      ...
      <q-input outlined class="q-my-xs q-mx-sm" type="text" id="create-from" name="name" required
              minlength="4" maxlength="50" size="10"></q-input>

      <q-label for="create-to">To</q-label>
      <q-input outlined class="q-my-xs q-mx-sm" type="text" id="create-to" name="name" required
              minlength="4" maxlength="50" size="10"></q-input>

      <q-label for="create-message">Message (250 Characters)</q-label>
      <q-input outlined class="q-my-xs q-mx-sm" 
